...
$sql="INSERT INTO colleges(collegename,location,
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Add colleges </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<!---->
  <div class="grid-form1">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control1" name="collegename" id="packagename" placeholder="Enter college  name" required>
									</div>
								</div>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">college Image</label>
									<div class="col-sm-8">
