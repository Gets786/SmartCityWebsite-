...
$sql="INSERT INTO busstand(busstandname,location,
...
if($lastInsertId)
{
$msg="Bus Stand  added Successfully";
}
else 
{
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Add Bus Stand </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<!---->
  <div class="grid-form1">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control1" name="busstandname" id="packagename" placeholder="Enter Bus Stand  name" required>
									</div>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Bus stand Image</label>
									<div class="col-sm-8">
