...
$sql="INSERT INTO museum(museumname,location,
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Add Museum </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<!---->
  <div class="grid-form1">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control1" name="museumname" id="packagename" placeholder="Enter meseum  name" required>
									</div>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Museum Image</label>
									<div class="col-sm-8">
