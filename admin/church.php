...
$sql="INSERT INTO church(cname,location,
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Add Church </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<!---->
  <div class="grid-form1">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control1" name="cname" id="packagename" placeholder="Enter Church  name" required>
									</div>
...
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Chuch  Details</label>
									<div class="col-sm-8">
										<textarea class="form-control" rows="5" cols="50" name="details" id="packagedetails" placeholder="Enter  Details" required></textarea> 
									</div>
								</div>															
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Church Image</label>
									<div class="col-sm-8">
