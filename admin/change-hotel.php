...
$sql="update hotels set image=:pimage where id=:imgid";
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Update Hotel Image </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="grid-form1">
  	       <h3>Update Hotel Image </h3>
  	         ...
  	         <div class="tab-content">
						...
						<?php 
$imgid=intval($_GET['imgid']);
$sql = "SELECT image from hotels where id=:imgid";
$query = $dbh -> prepare($sql);
$query -> bindParam(':imgid', $imgid, PDO::PARAM_STR);
$query->execute();
